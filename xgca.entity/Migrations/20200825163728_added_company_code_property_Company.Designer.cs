...
namespace xgca.entity.Migrations
{
    ...
    [Migration("20200825163728_added_company_code_property_Company")]
    partial class added_company_code_property_Company
    {
            ...
            modelBuilder.Entity("xgca.entity.Models.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CountryName = "Global",
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 25, 16, 37, 27, 458, DateTimeKind.Utc).AddTicks(9185),
                            FullAddress = "None",
                            ...
                            Longitude = "None",
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 25, 16, 37, 27, 459, DateTimeKind.Utc).AddTicks(1397),
                            StateId = 1,
                            StateName = "None",
                            ZipCode = "None"
                        });
            ...
            modelBuilder.Entity("xgca.entity.Models.AddressType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AddressTypeId = 1,
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 25, 16, 37, 27, 453, DateTimeKind.Utc).AddTicks(9493),
                            Guid = new Guid("1e0621b2-b7ea-4d48-8be2-f09980694816"),
                            IsDeleted = (byte)0,
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 25, 16, 37, 27, 454, DateTimeKind.Utc).AddTicks(1783),
                            Name = "Company"
                        },
                        new
                        {
                            AddressTypeId = 2,
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 25, 16, 37, 27, 457, DateTimeKind.Utc).AddTicks(1721),
                            Guid = new Guid("95ec682b-074f-42bb-9fed-d4dbde41e41d"),
                            IsDeleted = (byte)0,
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 25, 16, 37, 27, 457, DateTimeKind.Utc).AddTicks(1765),
                            Name = "Residential"
                        });
                });
            ...
            modelBuilder.Entity("xgca.entity.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ContactDetailId = 1,
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 25, 16, 37, 27, 462, DateTimeKind.Utc).AddTicks(7543),
                            EmailAddress = "None",
                            Guid = new Guid("3608a083-fbe5-44d5-afef-c7814100aec7"),
                            ImageURL = "None",
                            IsDeleted = (byte)1,
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 25, 16, 37, 27, 462, DateTimeKind.Utc).AddTicks(9672),
                            Status = (byte)0,
                            TaxExemption = (byte)0,
            ...
            modelBuilder.Entity("xgca.entity.Models.CompanyGroupResource", b =>
                {
                    ...
                    b.Property<Guid>("Guid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("fbb5575e-d45a-4d22-a578-3e624561ee80"));
            ...
            modelBuilder.Entity("xgca.entity.Models.ContactDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ContactDetailId = 1,
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 25, 16, 37, 27, 460, DateTimeKind.Utc).AddTicks(9690),
                            Fax = "None",
                            FaxPrefix = "None",
                            FaxPrefixId = 1,
                            ...
                            MobilePrefixId = 1,
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 25, 16, 37, 27, 461, DateTimeKind.Utc).AddTicks(1871),
                            Phone = "None",
                            PhonePrefix = "None",
                            PhonePrefixId = 1
                        });
            ...
            modelBuilder.Entity("xgca.entity.Models.Guest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CountryName = "Global",
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 25, 16, 37, 27, 466, DateTimeKind.Utc).AddTicks(4562),
                            DeletedBy = 0,
                            DeletedOn = new DateTime(2020, 8, 25, 16, 37, 27, 466, DateTimeKind.Utc).AddTicks(9920),
                            EmailAddress = "None",
                            FaxNumber = "None",
                            ...
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 25, 16, 37, 27, 466, DateTimeKind.Utc).AddTicks(6703),
                            PhoneNumber = "None",

...
namespace xgca.entity.Migrations
{
    ...
    [Migration("20200824113240_added_invite_foreign_key_Company")]
    partial class added_invite_foreign_key_Company
    {
            ...
            modelBuilder.Entity("xgca.entity.Models.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CountryName = "Global",
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 24, 11, 32, 40, 51, DateTimeKind.Utc).AddTicks(6300),
                            FullAddress = "None",
                            ...
                            Longitude = "None",
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 24, 11, 32, 40, 51, DateTimeKind.Utc).AddTicks(7502),
                            StateId = 1,
                            StateName = "None",
                            ZipCode = "None"
                        });
            ...
            modelBuilder.Entity("xgca.entity.Models.AddressType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AddressTypeId = 1,
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 24, 11, 32, 40, 48, DateTimeKind.Utc).AddTicks(6244),
                            Guid = new Guid("1e0621b2-b7ea-4d48-8be2-f09980694816"),
                            IsDeleted = (byte)0,
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 24, 11, 32, 40, 48, DateTimeKind.Utc).AddTicks(8303),
                            Name = "Company"
                        },
                        new
                        {
                            AddressTypeId = 2,
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 24, 11, 32, 40, 50, DateTimeKind.Utc).AddTicks(5340),
                            Guid = new Guid("95ec682b-074f-42bb-9fed-d4dbde41e41d"),
                            IsDeleted = (byte)0,
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 24, 11, 32, 40, 50, DateTimeKind.Utc).AddTicks(5383),
                            Name = "Residential"
                        });
                });
            ...
            modelBuilder.Entity("xgca.entity.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ContactDetailId = 1,
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 24, 11, 32, 40, 53, DateTimeKind.Utc).AddTicks(9212),
                            EmailAddress = "None",
                            Guid = new Guid("3608a083-fbe5-44d5-afef-c7814100aec7"),
                            ImageURL = "None",
                            IsDeleted = (byte)1,
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 24, 11, 32, 40, 54, DateTimeKind.Utc).AddTicks(379),
                            Status = (byte)0,
                            TaxExemption = (byte)0,
            ...
            modelBuilder.Entity("xgca.entity.Models.CompanyGroupResource", b =>
                {
                    ...
                    b.Property<Guid>("Guid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("aa2ce8c8-b78d-45b3-85f5-d8d63c4858db"));
            ...
            modelBuilder.Entity("xgca.entity.Models.ContactDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ContactDetailId = 1,
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 24, 11, 32, 40, 52, DateTimeKind.Utc).AddTicks(9297),
                            Fax = "None",
                            FaxPrefix = "None",
                            FaxPrefixId = 1,
                            ...
                            MobilePrefixId = 1,
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 24, 11, 32, 40, 53, DateTimeKind.Utc).AddTicks(719),
                            Phone = "None",
                            PhonePrefix = "None",
                            PhonePrefixId = 1
                        });
            ...
            modelBuilder.Entity("xgca.entity.Models.Guest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CountryName = "Global",
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 24, 11, 32, 40, 56, DateTimeKind.Utc).AddTicks(1790),
                            DeletedBy = 0,
                            DeletedOn = new DateTime(2020, 8, 24, 11, 32, 40, 56, DateTimeKind.Utc).AddTicks(4715),
                            EmailAddress = "None",
                            FaxNumber = "None",
                            ...
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 24, 11, 32, 40, 56, DateTimeKind.Utc).AddTicks(2978),
                            PhoneNumber = "None",

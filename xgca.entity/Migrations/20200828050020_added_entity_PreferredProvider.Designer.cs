...
namespace xgca.entity.Migrations
{
    ...
    [Migration("20200828050020_added_entity_PreferredProvider")]
    partial class added_entity_PreferredProvider
    {
            ...
            modelBuilder.Entity("xgca.entity.Models.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CountryName = "Global",
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 28, 5, 0, 19, 268, DateTimeKind.Utc).AddTicks(383),
                            FullAddress = "None",
                            ...
                            Longitude = "None",
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 28, 5, 0, 19, 268, DateTimeKind.Utc).AddTicks(2633),
                            StateId = 1,
                            StateName = "None",
                            ZipCode = "None"
                        });
            ...
            modelBuilder.Entity("xgca.entity.Models.AddressType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AddressTypeId = 1,
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 28, 5, 0, 19, 262, DateTimeKind.Utc).AddTicks(8692),
                            Guid = new Guid("1e0621b2-b7ea-4d48-8be2-f09980694816"),
                            IsDeleted = (byte)0,
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 28, 5, 0, 19, 263, DateTimeKind.Utc).AddTicks(1320),
                            Name = "Company"
                        },
                        new
                        {
                            AddressTypeId = 2,
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 28, 5, 0, 19, 266, DateTimeKind.Utc).AddTicks(2427),
                            Guid = new Guid("95ec682b-074f-42bb-9fed-d4dbde41e41d"),
                            IsDeleted = (byte)0,
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 28, 5, 0, 19, 266, DateTimeKind.Utc).AddTicks(2474),
                            Name = "Residential"
                        });
                });
            ...
            modelBuilder.Entity("xgca.entity.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ContactDetailId = 1,
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 28, 5, 0, 19, 272, DateTimeKind.Utc).AddTicks(1083),
                            EmailAddress = "None",
                            Guid = new Guid("3608a083-fbe5-44d5-afef-c7814100aec7"),
                            ImageURL = "None",
                            IsDeleted = (byte)1,
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 28, 5, 0, 19, 272, DateTimeKind.Utc).AddTicks(3346),
                            Status = (byte)0,
                            TaxExemption = (byte)0,
            ...
            modelBuilder.Entity("xgca.entity.Models.CompanyGroupResource", b =>
                {
                    ...
                    b.Property<Guid>("Guid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("f3266c93-14d6-4ac3-b0db-e962df564c28"));
            ...
            modelBuilder.Entity("xgca.entity.Models.ContactDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ContactDetailId = 1,
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 28, 5, 0, 19, 270, DateTimeKind.Utc).AddTicks(1100),
                            Fax = "None",
                            FaxPrefix = "None",
                            FaxPrefixId = 1,
                            ...
                            MobilePrefixId = 1,
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 28, 5, 0, 19, 270, DateTimeKind.Utc).AddTicks(3430),
                            Phone = "None",
                            PhonePrefix = "None",
                            PhonePrefixId = 1
                        });
            ...
            modelBuilder.Entity("xgca.entity.Models.Guest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CountryName = "Global",
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 28, 5, 0, 19, 276, DateTimeKind.Utc).AddTicks(5952),
                            DeletedBy = 0,
                            DeletedOn = new DateTime(2020, 8, 28, 5, 0, 19, 277, DateTimeKind.Utc).AddTicks(1922),
                            EmailAddress = "None",
                            FaxNumber = "None",
                            ...
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 28, 5, 0, 19, 276, DateTimeKind.Utc).AddTicks(8480),
                            PhoneNumber = "None",

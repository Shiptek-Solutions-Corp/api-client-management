...
namespace xgca.entity.Migrations
{
    ...
    [Migration("20200825065250_added_entity_for_monitoring_invite_code")]
    partial class added_entity_for_monitoring_invite_code
    {
            ...
            modelBuilder.Entity("xgca.entity.Models.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CountryName = "Global",
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 25, 6, 52, 49, 837, DateTimeKind.Utc).AddTicks(8615),
                            FullAddress = "None",
                            ...
                            Longitude = "None",
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 25, 6, 52, 49, 838, DateTimeKind.Utc).AddTicks(47),
                            StateId = 1,
                            StateName = "None",
                            ZipCode = "None"
                        });
            ...
            modelBuilder.Entity("xgca.entity.Models.AddressType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AddressTypeId = 1,
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 25, 6, 52, 49, 834, DateTimeKind.Utc).AddTicks(4601),
                            Guid = new Guid("1e0621b2-b7ea-4d48-8be2-f09980694816"),
                            IsDeleted = (byte)0,
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 25, 6, 52, 49, 834, DateTimeKind.Utc).AddTicks(6959),
                            Name = "Company"
                        },
                        new
                        {
                            AddressTypeId = 2,
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 25, 6, 52, 49, 836, DateTimeKind.Utc).AddTicks(7705),
                            Guid = new Guid("95ec682b-074f-42bb-9fed-d4dbde41e41d"),
                            IsDeleted = (byte)0,
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 25, 6, 52, 49, 836, DateTimeKind.Utc).AddTicks(7738),
                            Name = "Residential"
                        });
                });
            ...
            modelBuilder.Entity("xgca.entity.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ContactDetailId = 1,
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 25, 6, 52, 49, 840, DateTimeKind.Utc).AddTicks(7724),
                            EmailAddress = "None",
                            Guid = new Guid("3608a083-fbe5-44d5-afef-c7814100aec7"),
                            ImageURL = "None",
                            IsDeleted = (byte)1,
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 25, 6, 52, 49, 841, DateTimeKind.Utc).AddTicks(22),
                            Status = (byte)0,
                            TaxExemption = (byte)0,
            ...
            modelBuilder.Entity("xgca.entity.Models.CompanyGroupResource", b =>
                {
                    ...
                    b.Property<Guid>("Guid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("d3395554-5023-4e17-af81-2d66d0e18f04"));
            ...
            modelBuilder.Entity("xgca.entity.Models.ContactDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ContactDetailId = 1,
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 25, 6, 52, 49, 839, DateTimeKind.Utc).AddTicks(3758),
                            Fax = "None",
                            FaxPrefix = "None",
                            FaxPrefixId = 1,
                            ...
                            MobilePrefixId = 1,
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 25, 6, 52, 49, 839, DateTimeKind.Utc).AddTicks(5383),
                            Phone = "None",
                            PhonePrefix = "None",
                            PhonePrefixId = 1
                        });
            ...
            modelBuilder.Entity("xgca.entity.Models.Guest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CountryName = "Global",
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 25, 6, 52, 49, 843, DateTimeKind.Utc).AddTicks(7469),
                            DeletedBy = 0,
                            DeletedOn = new DateTime(2020, 8, 25, 6, 52, 49, 844, DateTimeKind.Utc).AddTicks(956),
                            EmailAddress = "None",
                            FaxNumber = "None",
                            ...
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 25, 6, 52, 49, 843, DateTimeKind.Utc).AddTicks(8918),
                            PhoneNumber = "None",

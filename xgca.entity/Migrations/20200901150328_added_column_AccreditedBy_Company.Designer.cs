...
namespace xgca.entity.Migrations
{
    ...
    [Migration("20200901150328_added_column_AccreditedBy_Company")]
    partial class added_column_AccreditedBy_Company
    {
            ...
            modelBuilder.Entity("xgca.entity.Models.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CountryName = "Global",
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 9, 1, 15, 3, 27, 329, DateTimeKind.Utc).AddTicks(9336),
                            FullAddress = "None",
                            ...
                            Longitude = "None",
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 9, 1, 15, 3, 27, 330, DateTimeKind.Utc).AddTicks(303),
                            StateId = 1,
                            StateName = "None",
                            ZipCode = "None"
                        });
            ...
            modelBuilder.Entity("xgca.entity.Models.AddressType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AddressTypeId = 1,
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 9, 1, 15, 3, 27, 327, DateTimeKind.Utc).AddTicks(5880),
                            Guid = new Guid("1e0621b2-b7ea-4d48-8be2-f09980694816"),
                            IsDeleted = (byte)0,
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 9, 1, 15, 3, 27, 327, DateTimeKind.Utc).AddTicks(6884),
                            Name = "Company"
                        },
                        new
                        {
                            AddressTypeId = 2,
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 9, 1, 15, 3, 27, 329, DateTimeKind.Utc).AddTicks(1797),
                            Guid = new Guid("95ec682b-074f-42bb-9fed-d4dbde41e41d"),
                            IsDeleted = (byte)0,
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 9, 1, 15, 3, 27, 329, DateTimeKind.Utc).AddTicks(1824),
                            Name = "Residential"
                        });
                });
            ...
            modelBuilder.Entity("xgca.entity.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ContactDetailId = 1,
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 9, 1, 15, 3, 27, 331, DateTimeKind.Utc).AddTicks(5656),
                            EmailAddress = "None",
                            Guid = new Guid("3608a083-fbe5-44d5-afef-c7814100aec7"),
                            ImageURL = "None",
                            IsDeleted = (byte)1,
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 9, 1, 15, 3, 27, 331, DateTimeKind.Utc).AddTicks(6575),
                            Status = (byte)0,
                            TaxExemption = (byte)0,
            ...
            modelBuilder.Entity("xgca.entity.Models.CompanyGroupResource", b =>
                {
                    ...
                    b.Property<Guid>("Guid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("b475b838-b2c5-4b97-86d8-d1af0995e103"));
            ...
            modelBuilder.Entity("xgca.entity.Models.ContactDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ContactDetailId = 1,
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 9, 1, 15, 3, 27, 330, DateTimeKind.Utc).AddTicks(8102),
                            Fax = "None",
                            FaxPrefix = "None",
                            FaxPrefixId = 1,
                            ...
                            MobilePrefixId = 1,
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 9, 1, 15, 3, 27, 330, DateTimeKind.Utc).AddTicks(9082),
                            Phone = "None",
                            PhonePrefix = "None",
                            PhonePrefixId = 1
                        });
            ...
            modelBuilder.Entity("xgca.entity.Models.Guest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CountryName = "Global",
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 9, 1, 15, 3, 27, 333, DateTimeKind.Utc).AddTicks(2037),
                            DeletedBy = 0,
                            DeletedOn = new DateTime(2020, 9, 1, 15, 3, 27, 333, DateTimeKind.Utc).AddTicks(4317),
                            EmailAddress = "None",
                            FaxNumber = "None",
                            ...
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 9, 1, 15, 3, 27, 333, DateTimeKind.Utc).AddTicks(2980),
                            PhoneNumber = "None",

...
namespace xgca.entity.Migrations
{
    ...
    [Migration("20200825080341_updated_seeder_AddressType")]
    partial class updated_seeder_AddressType
    {
            ...
            modelBuilder.Entity("xgca.entity.Models.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CountryName = "Global",
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 25, 8, 3, 40, 329, DateTimeKind.Utc).AddTicks(1541),
                            FullAddress = "None",
                            ...
                            Longitude = "None",
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 25, 8, 3, 40, 329, DateTimeKind.Utc).AddTicks(3084),
                            StateId = 1,
                            StateName = "None",
                            ZipCode = "None"
                        });
            ...
            modelBuilder.Entity("xgca.entity.Models.AddressType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AddressTypeId = 1,
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 25, 8, 3, 40, 324, DateTimeKind.Utc).AddTicks(6276),
                            Guid = new Guid("1e0621b2-b7ea-4d48-8be2-f09980694816"),
                            IsDeleted = (byte)0,
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 25, 8, 3, 40, 324, DateTimeKind.Utc).AddTicks(7710),
                            Name = "Company"
                        },
                        new
                        {
                            AddressTypeId = 2,
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 25, 8, 3, 40, 327, DateTimeKind.Utc).AddTicks(7990),
                            Guid = new Guid("95ec682b-074f-42bb-9fed-d4dbde41e41d"),
                            IsDeleted = (byte)0,
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 25, 8, 3, 40, 327, DateTimeKind.Utc).AddTicks(8030),
                            Name = "Residential"
                        });
                });
            ...
            modelBuilder.Entity("xgca.entity.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ContactDetailId = 1,
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 25, 8, 3, 40, 331, DateTimeKind.Utc).AddTicks(8128),
                            EmailAddress = "None",
                            Guid = new Guid("3608a083-fbe5-44d5-afef-c7814100aec7"),
                            ImageURL = "None",
                            IsDeleted = (byte)1,
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 25, 8, 3, 40, 331, DateTimeKind.Utc).AddTicks(9471),
                            Status = (byte)0,
                            TaxExemption = (byte)0,
            ...
            modelBuilder.Entity("xgca.entity.Models.CompanyGroupResource", b =>
                {
                    ...
                    b.Property<Guid>("Guid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("cf1f204a-f287-4c6c-974e-d48ebe760b6f"));
            ...
            modelBuilder.Entity("xgca.entity.Models.ContactDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ContactDetailId = 1,
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 25, 8, 3, 40, 330, DateTimeKind.Utc).AddTicks(5202),
                            Fax = "None",
                            FaxPrefix = "None",
                            FaxPrefixId = 1,
                            ...
                            MobilePrefixId = 1,
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 25, 8, 3, 40, 330, DateTimeKind.Utc).AddTicks(6892),
                            Phone = "None",
                            PhonePrefix = "None",
                            PhonePrefixId = 1
                        });
            ...
            modelBuilder.Entity("xgca.entity.Models.Guest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CountryName = "Global",
                            CreatedBy = 0,
                            CreatedOn = new DateTime(2020, 8, 25, 8, 3, 40, 334, DateTimeKind.Utc).AddTicks(749),
                            DeletedBy = 0,
                            DeletedOn = new DateTime(2020, 8, 25, 8, 3, 40, 334, DateTimeKind.Utc).AddTicks(4134),
                            EmailAddress = "None",
                            FaxNumber = "None",
                            ...
                            ModifiedBy = 0,
                            ModifiedOn = new DateTime(2020, 8, 25, 8, 3, 40, 334, DateTimeKind.Utc).AddTicks(2192),
                            PhoneNumber = "None",

...
namespace xgca.entity.Migrations
{
    ...
    [Migration("20200804090134_added_entity_for_PreferredContacts")]
    partial class added_entity_for_PreferredContacts
    {
            ...
            modelBuilder.Entity("xgca.entity.Models.CompanyGroupResource", b =>
                {
                    ...
                    b.Property<Guid>("Guid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("821e7024-322c-45e0-963f-2697da01523a"));
            ...
            modelBuilder.Entity("xgca.entity.Models.PreferredContact", b =>
                {
                    ...
                    b.HasOne("xgca.entity.Models.Guest", "Guests")
                        .WithMany()

...
namespace xgca.core.Helpers
{
    ...
    {
        public static string GetConnectionString(string secretName, string region, string databaseName)// string accessKey, string secretKey, string databaseName)
        {
            string secret = "";
            ...
            // Your code goes here.
            //server=database-1-instance-1.cziyn8jygnr3.us-east-1.rds.amazonaws.com;port=3306;database=accreditationService;user=admin;password=mast3rk3y

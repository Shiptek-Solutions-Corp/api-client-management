...
namespace xgca.core.Services
{
    public interface ICompanySectionService
    {
        ...
        Task<(string, string, int, List<ErrorField>)> CheckOverallKYCStatus(int companyId);
    ...
    public class CompanySectionService : ICompanySectionService
    {
        ...
        public async Task<IGeneralModel> CreateInitialSections()
        {
            ...
            var tempKYCLogs = new List<CreateKYCLogModel>();
            foreach (var companySection in createResult)
            {
                ...
                tempKYCLogs.Add(new CreateKYCLogModel
                {
            ...
            if (tempKYCLogs.Count != 0)
            {
                var kycLogs = new BulkCreateKYCLogModel();
                kycLogs.KYCLogs = tempKYCLogs;
        ...
        public async Task<GetCompanySectionModel> GetCompanySection(int companyId)
        {
            ...
            if (!(tempCompanyStructureSection is null))
            {
                ...
                if (tempCompanyStructureSection.Kyclog.Count != 0)
                {
                    latestRemarks = (tempCompanyStructureSection.Kyclog.OrderByDescending(o => o.CreatedOn).FirstOrDefault().Remarks is null)
                        ? "-"
                        : tempCompanyStructureSection.Kyclog.OrderByDescending(o => o.CreatedOn).FirstOrDefault().Remarks.ToString();
                }
            ...
            if (!(tempCompanyBeneficialOwnerSection is null))
            {
                ...
                string latestRemarks = "-";
                if (tempCompanyBeneficialOwnerSection.Kyclog.Count != 0)
                {
                    latestRemarks = (tempCompanyBeneficialOwnerSection.Kyclog.OrderByDescending(o => o.CreatedOn).FirstOrDefault().Remarks is null)
                        ? "-"
                        : tempCompanyBeneficialOwnerSection.Kyclog.OrderByDescending(o => o.CreatedOn).FirstOrDefault().Remarks.ToString();
                }
            ...
            if (!(tempCompanyDirectorSection is null))
            {
                ...
                string latestRemarks = "-";
                if (tempCompanyDirectorSection.Kyclog.Count != 0)
                {
                    latestRemarks = (tempCompanyDirectorSection.Kyclog.OrderByDescending(o => o.CreatedOn).FirstOrDefault().Remarks is null)
                        ? "-"
                        : tempCompanyDirectorSection.Kyclog.OrderByDescending(o => o.CreatedOn).FirstOrDefault().Remarks.ToString();
                }
        ...
        public async Task<(string, string, int, List<ErrorField>)> CheckOverallKYCStatus(int companyId)
        {
            ...
            return (kycStatus, responseMessage, statusCode, errors);
        ...
        public async Task<GetCompanyStructureSectionModel> GetCompanyStructureSection(string id)
        {
            ...
            if (!(companySection is null))
            {
                ...
                string latestRemarks = "-";
                if (companySection.Kyclog.Count != 0)
                {
                    latestRemarks = (companySection.Kyclog.OrderByDescending(o => o.CreatedOn).FirstOrDefault().Remarks is null)
                        ? "-"
                        : companySection.Kyclog.OrderByDescending(o => o.CreatedOn).FirstOrDefault().Remarks.ToString();
                }
        ...
        public async Task<IGeneralModel> SubmitCompanyStructureSection(UpdateCompanyStructureSectionModel obj, int companyId)
        {
            ...
            var (kycStatus, responseMessage, statusCode, errors) = await CheckOverallKYCStatus(companyId);
        ...
        public async Task<IGeneralModel> RejectCompanyStructureSection(string companyGuid)
        {
            ...
            var (overallKYCStatus, responseMessage, statusCode, errors) = await CheckCompanyKYCStatus(companyId);
        ...
        public async Task<(string, string, int, List<ErrorField>)> CheckCompanyKYCStatus(int companyId)
        {
            ...
            return (companyKYCStatus, responseMessage, statusCode, errors);
        }

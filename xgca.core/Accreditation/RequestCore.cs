...
namespace xas.core.accreditation.Request
{
    public interface IRequestCore
    {
        ...
        Task<GeneralModel> GetAccreditationStats(string bound, Guid loginCompanyGuid, Guid loginServiceRoleGuid, Guid serviceRoleGuid);
        ...
        Task<GeneralModel> GetAccreditedTruckingCompanies(Guid companyGuid, bool IsSupplementary);
    ...
    public class RequestCore : IRequestCore
    {
        ...
        public async Task<GeneralModel> GetAccreditationStats(string bound, Guid loginCompanyGuid, Guid loginServiceRoleGuid, Guid serviceRoleGuid)
        {
            var  response = await _requestData.GetStatusStatistics(bound, loginCompanyGuid, loginServiceRoleGuid, serviceRoleGuid);  
        ...
        public async Task<GeneralModel> GetAccreditedTruckingCompanies(Guid companyGuid, bool IsSupplementary)
        {
            var response = await _requestData.GetAccreditedTruckingCompanies(companyGuid, IsSupplementary);
